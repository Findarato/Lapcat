...
var locations={
      ...
      "FL":{
         ...
         "counter":2,
         "street":"7981 E. St. Rd. 4 (P.O. Box 125)",
				...
				.append(
					function(){
						if(dayOfWeek == a){
							return $("<div/>")
								.html(
									$("<div/>",{title:"Hours"}).html(locations[locationCode]["time"+a]).css("font-weight","bold")
								)
						}else{
							return $("<div/>")
								.html(
									$("<div/>",{title:"Hours"}).html(locations[locationCode]["time"+a])	
								)
						}
					}
				)
