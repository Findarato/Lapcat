<?php
   ...
   //define('CACHE_LENGTH', 3600); // length of time to cache output file, default approx 1 year
   //define('CREATE_ARCHIVE', true); // set to false to suppress writing of code archive, files will be merged on each request
   //define('ARCHIVE_FOLDER', '/archive'); // location to store archive, don't add starting or trailing slashes
   $FILE_TYPE='text/css';
   $CACHE_LENGTH = 3600;
   $CREATE_ARCHIVE = true;
   ...
   $sDocRoot = $_SERVER['DOCUMENT_ROOT']."/lapcat/css";
