...
<!--// Account Box //-->
<div class="color-X-1 corners-top-3 corners-bottom-3 shadow-or-light-X-up" id="anchored-account-box" style="padding:2px; position:fixed; bottom:-120px; left:1%; width:98%; z-index:10;">
...
<div class="color-X-1 corners-top-3 corners-bottom-3 shadow-or-light-X-up" id="anchored-message-box" style="background-position:0px 2px; position:fixed; bottom:-114px; left:1%; width:98%; z-index:10;">
	<div style="margin-top:96px; position:absolute; text-align:center; width:98%; z-index:11;"><font class="fake-link" style="color:rgb(0,0,255); font-size:11px; text-decoration:underline;">About Us / Terms of Use</font></div>
	<div class="border-all-I-1 corners-top-2 corners-bottom-2 shadow-or-light-X-up" style="height:90px; padding:4px; width:auto;">
		<table cellpadding="0" cellspacing="0" style="width:100%;">
			<tr>
				<td style="width:auto;">
