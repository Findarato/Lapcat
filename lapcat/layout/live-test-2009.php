...
<div id="line-HTML-600" style="display:none;">
	...
	<table cellpadding="0" cellspacing="0" style="width:100%;">
		<tr>
			...
			<td style="width:auto;">
	<div class="color-X-4 corners-bottom-3 corners-top-3 fake-link effect-hover-Z-2 light-up line-click" id="materials-replace-ID" name="counter-replace-counter" style="float:left; height:42px; text-align:center; width:100%;">
		<div class="border-sides-C-1 border-top-C-1 corners-top-2" style="height:19px; overflow:hidden; text-align:left; width:auto;">
			<table style="height:18px; width:100%;">
				<tr>
					<td style="height:18px; overflow:hidden; vertical-align:top; width:auto;">
...
<div class="color-A-1" id="stage-play" style="width:100%;">
	<div class="image-background" id="background-alignment" style="height:1050px; width:auto;">
		<div class="background-special-1 border-bottom-B-1" style="height:21px; width:100%;">
			...
			<div id="user-access" style="float:right; vertical-align:bottom; padding-top:1px; visibility:visible; width:222px;">
				<form action="/lapcat/code/accounts.php" method="post">
					<img src="http://cdn1.lapcat.org/famfamfam/silk/key_go.png" style="float:left; height:16px; margin-left:2px; margin-right:2px; margin-top:1px; width:16px;" />
					<input autocomplete="OFF" class="corners-bottom-1 corners-top-1 dropdown-A-1 image-lines" name="username" type="text" style="float:left; height:14px; margin-right:6px; width:90px;" value="account">
					<input autocomplete="OFF" class="dropdown-A-1 image-lines" name="pass" type="password" style="float:left; height:14px; margin-right:6px; width:90px;" value="password">
				</form>
			</div>
			...
			<div style="float:right; margin-right:12px; padding-top:1px;">
				<div class="give-link fake-link button-green" onfocus="javascript:this.blur();" style="float:left; height:16px; margin-left:3px; padding-left:3px; padding-right:3px; text-align:center; vertical-align:top; width:auto;" title="Give"><font class="font-G" style="vertical-align:top; font-size:14px;"><img src="http://cdn1.lapcat.org/famfamfam/silk/world.png" style="height:12px; margin-right:2px; width:12px;" />Give</font></div>
			</div>

			<!--// LINK - Options //-->
			<div style="float:right; margin-right:12px; padding-top:1px;">
				<div class="browse-link fake-link button-theme" name="https://dev.lapcat.org/lapcat/code/options.php?url=continue" onfocus="javascript:this.blur();" style="float:left; height:16px; margin-left:3px; padding-left:3px; padding-right:3px; text-align:center; vertical-align:top; width:auto;" title="Options"><font class="font-G" style="vertical-align:top; font-size:14px;">Options</font></div>
			</div>


			<!--// LINK - Catalog //-->
			<div style="float:right; margin-right:12px; padding-top:1px;">
				<div class="browse-link fake-link button-theme" name="http://catalog.lapcat.org" onfocus="javascript:this.blur();" style="float:left; height:16px; margin-left:3px; padding-left:3px; padding-right:3px; text-align:center; vertical-align:top; width:auto;" title="Catalog"><font class="font-G" style="vertical-align:top; font-size:14px;">Catalog</font></div>
			</div>
		...
		<div style="float:left; height:60px; width:100%;">
			...
			<div style="float:left; height:60px; margin-left:8px; width:101px;">
				<a href="javascript:F_MR('/quick/home/reset',true);" onfocus="javascript:this.blur();"><img src="/lapcat/images/101-58-1.png" style="height:58px; width:101px;"/></a>
			</div>
			<div style="float:left; height:60px; width:179px;">
				<a href="javascript:F_MR('/quick/home/reset',true);" onfocus="javascript:this.blur();"><img src="/lapcat/images/100-18-0.png" style="height:18px; margin-top:10px; width:100px;"/></a><font class="font-I" style="margin-left:2px;">&trade;</font><br/><font style="font-size:14px;">My Library, Online</font>
			</div>
	...
	<div class="drops-out-top" id="container-change-search" style="display:none; float:left; height:24px; padding-left:3px; padding-top:6px; width:176px;">
		<font>
		<div class="dropdown drops-out" id="change-search-drops-lines" style="display:none; margin-top:24px; margin-left:1px; position:absolute; width:175px; z-index:10;"></div>
		</font>
		<div style="float:left; width:33px;">
		...
		<div style="float:left; width:14px;">
			<div id="search-selected" style="display:none; float:right; height:15px; padding-left:3px; padding-top:4px; width:10px;">
				<img class="remove-search fake-link" src="http://cdn1.lapcat.org/famfamfam/silk/cross.png" style="float:left; width:12px; height:12px;" title="Click to remove this criteria from the search." />
			</div>
		</div>
	</div>
	...
	<div class="drops-out-top" id="container-change-sort" style="display:none; float:left; height:24px; padding-left:3px; padding-top:6px; width:176px;">
		...
		<div style="float:left; width:14px;">
			<div id="sort-selected" style="display:none; float:right; height:15px; padding-left:3px; padding-top:4px; width:10px;">
				<img class="remove-sort fake-link" src="http://cdn1.lapcat.org/famfamfam/silk/cross.png" style="float:left; width:12px; height:12px;" title="Click to remove this criteria from the search." />
			</div>
		</div>
	</div>
	...
	<div id="container-date-selector" style="display:none; float:left; height:24px; padding-left:3px; padding-top:6px; width:176px;">
		...
		<div style="float:left; width:14px;">
			<div id="date-selected" style="display:none; float:right; height:15px; padding-left:3px; padding-top:4px; width:10px;">
				<img class="remove-date fake-link" src="http://cdn1.lapcat.org/famfamfam/silk/cross.png" style="float:left; width:12px; height:12px;" title="Click to remove this criteria from the search." />
			</div>
		</div>
	</div>
...
<div id="construct-3" style="display:none; float:left; height:auto; padding:2px; overflow:hidden; width:auto;">
	<div style="max-height:512px; width:auto;">
		...
		<div class="float-left" id="master" name="construct-views"></div><div class="float-left" id="open-line" name="construct-views" style="display:none;"></div>
											...
											<div id="stage-month-view" style="display:none; max-width:820px; padding-left:2px; padding-top:2px; padding-right:2px;"></div>
										</div>
									</div>
								</td>
							</tr>
...
<div id="open-line-HTML-20" style="display:none; width:100%;">
	<div class="corners-top-2 corners-bottom-2" id="part-open-line" style="margin-top:6px; vertical-align:top; width:100%;">
		<div class="color-X-3 background-special-1" style="float:left; height:483px; width:100%;">
			<div class="border-all-C-1 corners-top-1 corners-bottom-1 shine-less" style="height:482px; position:relative; vertical-align:top; width:auto;">
				<div style="float:left; position:absolute; margin-top:20px; z-index:5; width:100%;">
					<table cellpadding="0" cellspacing="0" style="width:100%;">
						<tr>
							<td style="width:4px;"></td>
		...
		<div style="height:374px; width:auto;">
			<div style="height:374px; width:auto;">
				<div style="height:20px; width:auto;">
					<div style="float:left; vertical-align:top; width:auto;">
						<font class="font-H" style="font-size:10px; margin-left:12px;">at</font>
						<font class="library-link-1 font-H" name="library-replace-o_place" style="font-size:12px;">replace-library</font>
					</div>
					<div style="float:right; vertical-align:top; width:auto;">
						<font class="font-H" style="font-size:10px; margin-right:3px;">on</font>
						<a class="date-click fake-link" id="replace-o_date" style="font-size:14px; margin-right:12px;">replace-date-words</a>
					</div>
				</div>
...
<!--// Stage - News2 Content //-->
<div id="stage-news2-content" style="display:none;">
	<div class="color-Z-2 light-up" style="float:left; height:20px; width:100%;">
		...
		<font class="font-H" style="font-size:10px; margin-right:6px;"> VR</font></div>
	</div>
	<div style="float:left; width:100%;">
		<div style="height:374px; width:auto; margin-right:1px;">
			<div style="height:374px; width:auto;">
				<div style="height:20px; width:auto;">
					<div style="float:left; vertical-align:top; width:auto;">
						<font class="font-H" style="font-size:10px; margin-left:12px;">by</font>
						<font class="user-link-1 font-N" style="font-size:12px;">replace-username</font>
					</div>
					<div style="float:right; vertical-align:top; width:auto;">
						<font class="font-H" style="font-size:12px; margin-right:3px;">on</font>
						<a class="date-click fake-link" id="replace-entered_on" style="font-size:14px; margin-right:12px;">replace-date-words</a>
					</div>
				</div>
				<div style="height:383px; overflow:auto; width:100%;">
					<div class="border-bottom-C-1" style="float:left; height:1px; width:100%;"></div>
