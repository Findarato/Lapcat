<div id="stage-hours-content" style="display:block;">
		...
		<table cellpadding="0" cellspacing="0" style="height:460px; vertical-align:top; width:100%;">
			...
			<tr>
				<td style="height:390px; overflow:hidden; padding-left:6px; padding-right:6px; vertical-align:top; width:auto;">
					...
					<div class="border-all-I-1-65 corners-bottom-2 corners-top-2" style="float:left;background-image:url(/lapcat/layout/library/150-100-{$V_openLineData.ID}.png); height:100px; text-align:left; vertical-align:top; width:150px;"></div>
					<div class="font-X" style="float:left;margin-left:5px;">{$V_openLineData.street}<br>{$V_openLineData.city_state}<br>{$V_openLineData.zip}<br>{$V_openLineData.phone}</div>
					<table cellpadding="0" cellspacing="0" style="width:100%;">
						<tr>
							...
							<td style="width:auto;"><font id="current-day-time-0" class="font-X">{$V_openLineData.time_0}</font></td>
						</tr>
						<tr>
							...
							<td style="width:auto;"><font id="current-day-time-1" class="font-X">{$V_openLineData.time_1}</font></td>
						</tr>
						<tr>
							...
							<td style="width:auto;"><font id="current-day-time-2" class="font-X">{$V_openLineData.time_2}</font></td>
						</tr>
						<tr>
							...
							<td style="width:auto;"><font id="current-day-time-3" class="font-X">{$V_openLineData.time_3}</font></td>
						</tr>
						<tr>
							...
							<td style="width:auto;"><font id="current-day-time-4" class="font-X">{$V_openLineData.time_4}</font></td>
						</tr>
						<tr>
							...
							<td style="width:auto;"><font id="current-day-time-5" class="font-X">{$V_openLineData.time_5}</font></td>
						</tr>
						<tr>
							...
							<td style="width:auto;"><font id="current-day-time-6" class="font-X">{$V_openLineData.time_6}</font></td>
						</tr>
					</table>
