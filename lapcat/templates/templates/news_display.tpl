...
<div id="static-HTML-300" style="display:block;">
												...
												<table cellpadding="0" cellspacing="0" style="height:460px; vertical-align:top; width:100%;">
													...
													<tr>
														...
														<div class="shadow-or-light-X-up" style="height:20px; text-align:left; vertical-align:top; width:100%;">
															<font class="font-X" style="font-size:10px; margin-left:12px;">by</font>
															<font class="add-to-search user-link-1 font-X" name="construct|construct-3_key|search_value|replace-username_text|replace-entered-by-id" style="font-size:12px; margin-right:3px;">{$V_openLineData.username}</font>
														</div>
