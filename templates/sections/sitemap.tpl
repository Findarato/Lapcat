<div class="roundAll3 siteMap linearAnimate" id="siteMap" style="margin-bottom:20px;" title="Site Map">
	...
	<a href="research.php?sitemap=1">Research</a>
	<a href="/hours.php?sitemap=1">Hours and Locations</a>
	<a href="ask.php?sitemap=1">Ask a Librarian</a>
