...
<body>
	<div id="container" style="" class="container_24">
		...
		<div class="mainArea grid_24 mainBackground roundAll3" id="main" role="main">
			{include file="../sections/subpage_header.tpl" pageTitle="Educators" backgroundImage="images/LaPorte_County_Public_Library.jpg"}
			<div class="clear"></div>
			<section class="grid_16">
				{include file="../sections/research_adult.tpl" sectionTitle="Education Research Links"}
