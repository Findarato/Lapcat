  ...
  $.ajax({
    ...
    success: function (data) {
      for (var i = 0; i < num_to_display; i++) {
          ...
          jQuery('<div><a target="_blank" href="' + data.data[i].link +'"><img height=225px width=225px src="' + data.data[i].images.low_resolution.url + '" alt="' + data.data[i].caption.text + '"></a></div>')
